...
export const translations = {
  en: {
    ...
    shop: "All products",
    shopAll: "View all",
    shopDescription: "Unisex clothing and accessories for testing the full Starliar buying flow.",
    shopNow: "Shop Now",
  ...
  vi: {
    ...
    shop: "All products",
    shopAll: "Xem tất cả",
    shopDescription: "Quần áo và phụ kiện unisex cho trải nghiệm mua hàng Starliar.",
    shopNow: "Mua ngay",
    sizeGuide: "Bảng size",
    terms: "Điều khoản",
